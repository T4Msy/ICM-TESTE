...
const QUESTIONS = [
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    options:[
      {text:'Entrego o que está funcional com relatório técnico claro sobre o que falta — e o impacto de cada item pendente.',      points:{decisao:4,logica:4,sagacidade:3,maturidade:4}, tag:'decisao_estruturado'},
      {text:'Negoço mais 24h com argumento objetivo: o custo real de entregar incompleto supera qualquer prazo.',                  points:{decisao:5,logica:4,sagacidade:4,maturidade:5}, tag:'decisao_lider'},
      {text:'Entrego como está. Se reclamarem, corrijo depois.',                                                                   points:{decisao:2,logica:1,sagacidade:1,maturidade:2}, tag:'decisao_fraco'},
      {text:'Trabalho as próximas 12h sem parar para entregar tudo — perfeito ou não.',                                           points:{decisao:3,logica:2,sagacidade:2,maturidade:3}, tag:'decisao_impulsivo'},
    ],
  },
  {
    ...
    options:[
      {text:'Caminho A. Construção consistente supera qualquer aposta.',                                                           points:{decisao:3,logica:4,sagacidade:2,maturidade:4}, tag:'decisao_conservador'},
      {text:'Caminho B. Resultados medianos não constroem legado.',                                                               points:{decisao:4,logica:2,sagacidade:3,maturidade:2}, tag:'decisao_ousado'},
      {text:'Crio Caminho C — divido recursos para explorar B com proteção mínima via A.',                                        points:{decisao:5,logica:5,sagacidade:5,maturidade:4}, tag:'decisao_inovador'},
      {text:'Depende do custo real do fracasso B. Preciso dessa informação antes.',                                               points:{decisao:5,logica:5,sagacidade:4,maturidade:4}, tag:'decisao_analitico'},
    ],
  },
  {
    ...
    options:[
      {text:'Confronto diretamente em privado, com fatos — sem envolver outros.',                                                  points:{decisao:5,logica:3,sagacidade:3,maturidade:5}, tag:'decisao_direto'},
      {text:'Documento tudo e afasto-o silenciosamente das informações sensíveis até o projeto encerrar.',                        points:{decisao:4,logica:4,sagacidade:5,maturidade:3}, tag:'sagacidade_alta'},
      {text:'Ignoro e termino o projeto — conflito agora prejudica o resultado coletivo.',                                        points:{decisao:2,logica:3,sagacidade:3,maturidade:3}, tag:'decisao_evitativo'},
      {text:'Levo ao superior com evidências documentadas antes de qualquer confronto.',                                          points:{decisao:3,logica:3,sagacidade:2,maturidade:4}, tag:'decisao_institucional'},
    ],
  },
  {
    ...
    options:[
      {text:'Finalizo o projeto antes de qualquer movimentação. Comprometimento não é negociável.',                                points:{decisao:3,logica:3,sagacidade:2,maturidade:5}, tag:'maturidade_alta'},
      {text:'Aceito e garanto transição adequada — treino ou transfiro responsabilidade formalmente.',                             points:{decisao:5,logica:4,sagacidade:5,maturidade:4}, tag:'decisao_lider'},
      {text:'Recuso. 70% concluído é distância curta demais para abandonar.',                                                     points:{decisao:2,logica:3,sagacidade:1,maturidade:4}, tag:'decisao_conservador'},
      {text:'Negocio prazo com quem oferece a oportunidade — peço tempo para encerrar com qualidade.',                            points:{decisao:4,logica:4,sagacidade:5,maturidade:5}, tag:'decisao_analitico'},
    ],
  },
  {
    ...
    options:[
      {text:'Confio no padrão que funcionou em situações análogas.',                                                              points:{decisao:4,logica:3,sagacidade:3,maturidade:3}, tag:'decisao_intuitivo'},
      {text:'Escolho o caminho com menor potencial de dano irreversível.',                                                        points:{decisao:4,logica:4,sagacidade:3,maturidade:4}, tag:'decisao_analitico'},
      {text:'Peço 10 minutos — qualidade de decisão vale esse tempo.',                                                            points:{decisao:3,logica:4,sagacidade:2,maturidade:4}, tag:'decisao_estruturado'},
      {text:'Ajo com a opção mais ousada — inação tem custo maior.',                                                              points:{decisao:5,logica:2,sagacidade:3,maturidade:2}, tag:'decisao_ousado'},
    ],
  },
  {
    ...
    options:[
      {text:'30 dias com metas objetivas e consequência previamente definida. Estrutura antes de punição.',                       points:{decisao:4,logica:4,sagacidade:3,maturidade:5}, tag:'maturidade_alta'},
      {text:'Encerro. A complacência com um prejudica todo o coletivo que performa.',                                             points:{decisao:5,logica:3,sagacidade:2,maturidade:3}, tag:'decisao_lider'},
      {text:'Reposito para função mais alinhada ao perfil antes de qualquer demissão.',                                          points:{decisao:4,logica:5,sagacidade:5,maturidade:4}, tag:'decisao_inovador'},
      {text:'Consulto a equipe para entender o impacto antes de qualquer decisão.',                                              points:{decisao:3,logica:3,sagacidade:4,maturidade:3}, tag:'sagacidade_alta'},
    ],
  },

  // ── PERGUNTAS ESPELHADAS DE DECISÃO ──────────────────────────
  // Espelha d5: "Age rapidamente sem dados completos?"
  {
    ...
    options:[
      {text:'Raramente — sob pressão meu padrão de julgamento se mantém.',                    points:{decisao:4,logica:3,sagacidade:3,maturidade:4}, mirror_score:0.85, tag:'decisao_consistente'},
      {text:'Às vezes — reconheço que velocidade prejudica qualidade ocasionalmente.',         points:{decisao:3,logica:3,sagacidade:3,maturidade:4}, mirror_score:0.60, tag:'maturidade_media'},
      {text:'Com frequência — prefiro esperar mas nem sempre posso.',                          points:{decisao:2,logica:3,sagacidade:2,maturidade:3}, mirror_score:0.30, tag:'decisao_evitativo'},
  ...
  // Espelha d3: "Como lida com traição?"
  {
    ...
    options:[
      {text:'Avalio a reparação pelos méritos — passado é dado, não sentença permanente.',     points:{decisao:4,logica:4,sagacidade:5,maturidade:5}, mirror_score:0.75, tag:'maturidade_alta'},
      {text:'Aceito a reparação mas mantenho distância estratégica.',                          points:{decisao:4,logica:4,sagacidade:4,maturidade:4}, mirror_score:0.70, tag:'sagacidade_alta'},
      {text:'Rejeito. Confiança rompida não se recupera.',                                     points:{decisao:3,logica:2,sagacidade:2,maturidade:3}, mirror_score:0.45, tag:'decisao_conservador'},
      {text:'Finjo aceitar mas não abro mais acesso real.',                                    points:{decisao:3,logica:3,sagacidade:3,maturidade:1}, mirror_score:0.20, tag:'sagacidade_media'},
    ],
  },
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    options:[
      {text:'43 — diferença entre termos cresce +2 a cada passo: Δ=4,6,8,10,12.',            points:{decisao:1,logica:5,sagacidade:2,maturidade:1}, tag:'logica_alta'},
  ...
  },
  {
    ...
    options:[
      ...
      {text:'Alguns membros da Ordem podem ser filósofos.',                                    points:{decisao:1,logica:5,sagacidade:2,maturidade:1}, tag:'logica_alta'},
  ...
  },
  {
    ...
    options:[
      {text:'2 — divido em grupos de 3; o resultado define qual grupo pesquisar na 2ª pesagem.',points:{decisao:2,logica:5,sagacidade:3,maturidade:1}, tag:'logica_alta'},
      ...
      {text:'1 — com sorte.',                                                                   points:{decisao:2,logica:2,sagacidade:2,maturidade:1}, tag:'logica_baixa'},
    ],
  },
  {
    ...
    options:[
      {text:'A e D em paralelo → B (após A) → C (após B e D) → E.',                           points:{decisao:3,logica:5,sagacidade:4,maturidade:2}, tag:'logica_alta'},
      {text:'A → B → D → C → E.',                                                              points:{decisao:1,logica:2,sagacidade:1,maturidade:1}, tag:'logica_baixa'},
      {text:'D → A → B → C → E.',                                                              points:{decisao:2,logica:3,sagacidade:2,maturidade:1}, tag:'logica_media'},
  ...
  },
  {
    ...
    options:[
      {text:'Automatizo os pontos mais propensos a erro antes de acelerar.',                   points:{decisao:3,logica:5,sagacidade:5,maturidade:3}, tag:'logica_alta'},
      {text:'Aumento velocidade em ~30% — ponto de equilíbrio ótimo.',                        points:{decisao:4,logica:5,sagacidade:4,maturidade:3}, tag:'logica_alta'},
      {text:'Mantenho velocidade original. Qualidade não negocia.',                            points:{decisao:2,logica:3,sagacidade:1,maturidade:4}, tag:'decisao_conservador'},
      {text:'Acelero e adiciono revisão ao final de cada etapa.',                              points:{decisao:3,logica:4,sagacidade:3,maturidade:3}, tag:'logica_media'},
    ],
  },
  {
    ...
    options:[
      {text:'Ranqueio hipóteses por evidência disponível e testo a mais promissora primeiro.',  points:{decisao:4,logica:5,sagacidade:4,maturidade:4}, tag:'logica_alta'},
      {text:'Ajo na hipótese mais popular — velocidade importa mais que certeza.',              points:{decisao:4,logica:2,sagacidade:2,maturidade:2}, tag:'decisao_ousado'},
      {text:'Testo todas em paralelo — não posso descartar nenhuma prematuramente.',            points:{decisao:3,logica:3,sagacidade:3,maturidade:2}, tag:'logica_media'},
      {text:'Busco benchmarks externos antes de testar hipóteses internas.',                   points:{decisao:3,logica:5,sagacidade:4,maturidade:3}, tag:'logica_alta'},
    ],
  },
  // Espelha l1 — mesmo raciocínio, contexto diferente
  {
    ...
    options:[
      {text:'~75% — crescimento composto somado: 5+5.75+6.6+7.6+8.7 ≈ 33.6% não, 5+20+35... preciso calcular corretamente.',   points:{decisao:1,logica:2,sagacidade:1,maturidade:1}, tag:'logica_media'},
      {text:'Cerca de 35% — a soma das 5 parcelas em progressão geométrica: 5+5.75+6.6+7.6+8.7 ≈ 33.65%.',                    points:{decisao:1,logica:5,sagacidade:2,maturidade:1}, tag:'logica_alta'},
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    options:[
      {text:'Desmonto o argumento com calma e precisão — sem atacar a pessoa.',                points:{decisao:4,logica:4,sagacidade:5,maturidade:5}, tag:'sagacidade_alta'},
      {text:'Concordo superficialmente e retomo em privado depois.',                           points:{decisao:2,logica:2,sagacidade:4,maturidade:3}, tag:'sagacidade_media'},
      {text:'Peço que apresente dados concretos que sustentem a posição.',                     points:{decisao:4,logica:5,sagacidade:5,maturidade:4}, tag:'logica_alta'},
      {text:'Fico em silêncio — quem está certo não precisa se defender.',                    points:{decisao:2,logica:2,sagacidade:2,maturidade:3}, tag:'decisao_evitativo'},
    ],
  },
  {
    ...
    options:[
      {text:'Deixo concluir e avalio o pedido pelos méritos — não pelo ambiente emocional criado.',points:{decisao:3,logica:3,sagacidade:5,maturidade:5}, tag:'sagacidade_alta'},
      {text:'Interrompo antes do pedido e pergunto diretamente o que quer.',                  points:{decisao:5,logica:3,sagacidade:5,maturidade:3}, tag:'decisao_direto'},
      {text:'Finjo não perceber e registro isso como dado permanente sobre o caráter da pessoa.',points:{decisao:3,logica:3,sagacidade:5,maturidade:3}, tag:'sagacidade_alta'},
      {text:'Encerro educadamente a conversa antes do pedido.',                               points:{decisao:2,logica:2,sagacidade:2,maturidade:3}, tag:'decisao_evitativo'},
    ],
  },
  {
    ...
    options:[
      {text:'Reduzo o ritmo estrategicamente — poder de barganha aumenta com a escassez de tempo deles.',points:{decisao:4,logica:3,sagacidade:5,maturidade:3}, tag:'sagacidade_alta'},
      {text:'Apresento proposta melhorada com prazo de resposta de 24h — crio pressão legítima.',points:{decisao:4,logica:4,sagacidade:5,maturidade:4}, tag:'sagacidade_alta'},
      {text:'Aceito as condições deles para fechar logo — eficiência acima de margem.',        points:{decisao:3,logica:2,sagacidade:1,maturidade:2}, tag:'decisao_fraco'},
      {text:'Conduzo normalmente — usar urgência como alavanca não é ético.',                  points:{decisao:2,logica:2,sagacidade:2,maturidade:3}, tag:'maturidade_media'},
    ],
  },
  {
    ...
    options:[
      {text:'Recuso. Associações contaminam reputação — custo invisível mas real.',            points:{decisao:3,logica:2,sagacidade:3,maturidade:5}, tag:'maturidade_alta'},
      {text:'Aceito com estrutura contratual que limita minha exposição ao máximo.',           points:{decisao:4,logica:4,sagacidade:5,maturidade:3}, tag:'sagacidade_alta'},
      {text:'Extraio o que é útil sem me vincular publicamente à pessoa.',                    points:{decisao:4,logica:3,sagacidade:5,maturidade:2}, tag:'sagacidade_alta'},
      {text:'Investigo o histórico profundamente antes de qualquer resposta.',                 points:{decisao:3,logica:4,sagacidade:4,maturidade:4}, tag:'logica_alta'},
    ],
  },
  {
    ...
    options:[
      {text:'Aproximo-me em particular e ouço antes de qualquer decisão coletiva.',           points:{decisao:3,logica:3,sagacidade:5,maturidade:4}, tag:'sagacidade_alta'},
      {text:'Convido ativamente para que fale no grupo — visão oculta não pode permanecer oculta.',points:{decisao:3,logica:2,sagacidade:4,maturidade:5}, tag:'maturidade_alta'},
      {text:'Observo e aprendo silenciosamente — influência não precisa de holofote.',        points:{decisao:2,logica:3,sagacidade:5,maturidade:3}, tag:'sagacidade_alta'},
      {text:'Foco em quem fala — contribuição exige manifestação.',                           points:{decisao:2,logica:2,sagacidade:1,maturidade:2}, tag:'decisao_fraco'},
    ],
  },
  {
    ...
    options:[
      {text:'Apresento análise com dados ao responsável antes de falar ao grupo — hierarquia de informação importa.',points:{decisao:4,logica:4,sagacidade:5,maturidade:5}, tag:'sagacidade_alta'},
      {text:'Falo abertamente no grupo — verdade antecipada supera conforto temporário.',     points:{decisao:5,logica:3,sagacidade:3,maturidade:4}, tag:'decisao_direto'},
      {text:'Fico em silêncio e me posiciono para não ser afetado quando vier o fracasso.',   points:{decisao:2,logica:3,sagacidade:3,maturidade:1}, tag:'decisao_fraco'},
      {text:'Construo alternativas em paralelo enquanto o projeto segue.',                    points:{decisao:3,logica:4,sagacidade:4,maturidade:3}, tag:'sagacidade_media'},
    ],
  },
  // Espelha s2 — detecta manipulação (inverso)
  {
    ...
    options:[
      {text:'Apresento o pedido de forma direta e objetiva — méritos falam por si.',          points:{decisao:4,logica:3,sagacidade:3,maturidade:5}, mirror_score:0.80, tag:'decisao_direto'},
      {text:'Construo contexto antes do pedido — relacionamento primeiro, pedido depois.',    points:{decisao:3,logica:3,sagacidade:4,maturidade:4}, mirror_score:0.65, tag:'sagacidade_media'},
      {text:'Encontro o que posso oferecer em troca — negociação antes de pedido.',           points:{decisao:3,logica:4,sagacidade:5,maturidade:4}, mirror_score:0.70, tag:'sagacidade_alta'},
      {text:'Crio situações que façam a pessoa sentir que está escolhendo ajudar.',           points:{decisao:3,logica:3,sagacidade:4,maturidade:1}, mirror_score:0.15, tag:'sagacidade_manipuladora'},
    ],
  },
  // Espelha s3 — uso de vantagem de informação
  {
    ...
    options:[
      {text:'Uso a informação — vantagem de informação é resultado de preparo, não de trapaça.',points:{decisao:4,logica:3,sagacidade:4,maturidade:3}, mirror_score:0.70, tag:'sagacidade_alta'},
      {text:'Uso, mas com moderação — não exponho a vulnerabilidade do outro desnecessariamente.',points:{decisao:4,logica:4,sagacidade:5,maturidade:4}, mirror_score:0.75, tag:'sagacidade_alta'},
      {text:'Compartilho a informação voluntariamente — negociações justas produzem melhores acordos.',points:{decisao:3,logica:3,sagacidade:3,maturidade:5}, mirror_score:0.60, tag:'maturidade_alta'},
      {text:'Omito mas não minto ativamente se perguntado.',                                   points:{decisao:3,logica:3,sagacidade:4,maturidade:3}, mirror_score:0.55, tag:'sagacidade_media'},
    ],
  },
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    options:[
      {text:'Analiso o que causou o desvio, ajusto o sistema e recomeço sem drama.',          points:{decisao:3,logica:4,sagacidade:3,maturidade:5}, tag:'maturidade_alta'},
      {text:'Sinto raiva de mim mesmo, mas uso isso como combustível.',                       points:{decisao:3,logica:2,sagacidade:2,maturidade:3}, tag:'maturidade_media'},
      {text:'Identifico o aprendizado e documento para evitar o mesmo padrão.',               points:{decisao:3,logica:4,sagacidade:4,maturidade:5}, tag:'maturidade_alta'},
      {text:'Aceito que nem sempre é possível. Sigo em frente.',                              points:{decisao:2,logica:2,sagacidade:1,maturidade:2}, tag:'maturidade_baixa'},
    ],
  },
  {
    ...
    options:[
      {text:'Ouço com atenção, separo o válido do emocional e agradeço internamente — mesmo que doa.',points:{decisao:3,logica:3,sagacidade:4,maturidade:5}, tag:'maturidade_alta'},
      {text:'Me defendo no momento — crítica dura sem respeito não merece receptor passivo.',  points:{decisao:4,logica:2,sagacidade:2,maturidade:2}, tag:'decisao_ousado'},
      {text:'Fico quieto externamente, processo internamente e mudo o que precisa mudar.',    points:{decisao:2,logica:3,sagacidade:4,maturidade:4}, tag:'sagacidade_media'},
      {text:'Peço que reformule de forma mais construtiva antes de ouvir.',                   points:{decisao:3,logica:3,sagacidade:3,maturidade:3}, tag:'maturidade_media'},
    ],
  },
  {
    ...
    options:[
      {text:'Mantenho a consistência — resultados são consequência de processo, não urgência.',points:{decisao:3,logica:3,sagacidade:3,maturidade:5}, tag:'maturidade_alta'},
      {text:'Reviso o processo — ausência de resultado por esse tempo indica necessidade de ajuste.',points:{decisao:4,logica:5,sagacidade:4,maturidade:4}, tag:'logica_alta'},
      {text:'Questiono se o caminho ainda faz sentido — persistência cega é burrice.',        points:{decisao:4,logica:4,sagacidade:3,maturidade:3}, tag:'decisao_analitico'},
      {text:'Fico desmotivado mas me forço — disciplina sem prazer é possível.',              points:{decisao:2,logica:2,sagacidade:1,maturidade:2}, tag:'maturidade_baixa'},
    ],
  },
  {
    ...
    options:[
      {text:'Compartilho o crédito publicamente e imediatamente. Integridade não é condicional.',points:{decisao:3,logica:2,sagacidade:3,maturidade:5}, tag:'maturidade_alta'},
      {text:'Aceito em público e reconheço a pessoa em privado de forma significativa.',       points:{decisao:3,logica:3,sagacidade:3,maturidade:3}, tag:'maturidade_media'},
      {text:'Não digo nada — o sistema recompensa quem aparece, e eu apareci.',               points:{decisao:2,logica:2,sagacidade:3,maturidade:1}, tag:'maturidade_baixa'},
      {text:'Uso o crédito estrategicamente e compenso a pessoa de outra forma.',             points:{decisao:3,logica:3,sagacidade:4,maturidade:2}, tag:'sagacidade_media'},
    ],
  },
  {
    ...
    options:[
      {text:'É o custo necessário e consciente. Foco raramente coexiste com dispersão.',      points:{decisao:3,logica:3,sagacidade:3,maturidade:5}, tag:'maturidade_alta'},
      {text:'Estruturo blocos deliberados de conexão social — equilíbrio também é performance sustentável.',points:{decisao:4,logica:4,sagacidade:5,maturidade:4}, tag:'sagacidade_alta'},
      {text:'Diminuo o ritmo eventualmente — nenhuma meta vale isolamento prolongado.',       points:{decisao:3,logica:2,sagacidade:2,maturidade:3}, tag:'maturidade_media'},
      {text:'Priorizo quem compartilha a trajetória — os demais se afastam naturalmente.',    points:{decisao:3,logica:3,sagacidade:4,maturidade:4}, tag:'sagacidade_media'},
    ],
  },
  {
    ...
    options:[
      {text:'Admito o erro imediatamente e mudo de posição — clareza supera ego.',            points:{decisao:5,logica:3,sagacidade:4,maturidade:5}, tag:'maturidade_alta'},
      {text:'Paro a discussão, processo com calma e retorno para reconhecer.',                points:{decisao:3,logica:3,sagacidade:3,maturidade:4}, tag:'maturidade_alta'},
      {text:'Mudo de posição mas não verbalizo — ações futuras demonstrarão.',               points:{decisao:2,logica:2,sagacidade:3,maturidade:2}, tag:'sagacidade_media'},
      {text:'Continuo argumentando — conceder rápido demais demonstra instabilidade.',       points:{decisao:3,logica:2,sagacidade:2,maturidade:1}, tag:'maturidade_baixa'},
    ],
  },
  // Espelha m1 — consistência com autopercepção
  {
    ...
    options:[
      {text:'Sim — minha consistência é meu maior ativo.',                                    points:{decisao:3,logica:2,sagacidade:2,maturidade:4}, mirror_score:0.90, tag:'maturidade_autopercep_alta'},
      {text:'Em grande parte — com algumas áreas onde ainda luto com consistência.',          points:{decisao:3,logica:3,sagacidade:3,maturidade:4}, mirror_score:0.70, tag:'maturidade_media'},
      {text:'Parcialmente — sou disciplinado quando motivado, não como regra.',              points:{decisao:2,logica:3,sagacidade:2,maturidade:3}, mirror_score:0.45, tag:'maturidade_baixa'},
      {text:'Honestamente não — reconheço que consistência é meu ponto mais fraco.',         points:{decisao:2,logica:3,sagacidade:4,maturidade:3}, mirror_score:0.15, tag:'maturidade_autopercep_baixa'},
    ],
  },
  // Espelha m4 — ética com crédito (inverso)
  {
    ...
    options:[
      {text:'Nunca — integridade é praticada quando ninguém vê, especialmente então.',        points:{decisao:2,logica:2,sagacidade:2,maturidade:5}, mirror_score:0.95, tag:'maturidade_alta'},
      {text:'Raramente e sempre por omissão, não por afirmação ativa.',                      points:{decisao:2,logica:2,sagacidade:3,maturidade:4}, mirror_score:0.70, tag:'maturidade_media'},
      {text:'Às vezes — é difícil corrigir o outro quando o crédito já foi dado.',           points:{decisao:2,logica:2,sagacidade:3,maturidade:2}, mirror_score:0.40, tag:'maturidade_baixa'},
      {text:'Sim, e não considero isso um problema — sistemas meritocráticos são imperfeitos.',points:{decisao:2,logica:2,sagacidade:3,maturidade:1}, mirror_score:0.05, tag:'maturidade_baixa'},
    ],
  },
  ...
  ══════════════════════════════════════════════════════ */
  {
    ...
    options:[
      {text:'Demonstro competência antes de qualquer postura de liderança — resultados precedem respeito.',points:{decisao:5,logica:4,sagacidade:5,maturidade:5}, tag:'decisao_lider'},
      {text:'Construo aliados internos primeiro — influência lateral antes de autoridade vertical.',points:{decisao:4,logica:3,sagacidade:5,maturidade:4}, tag:'sagacidade_alta'},
      {text:'Imponho limites claros desde o início — ambiguidade cria conflito depois.',       points:{decisao:5,logica:3,sagacidade:3,maturidade:3}, tag:'decisao_direto'},
      {text:'Ouço o time antes de qualquer movimentação — contexto primeiro, ação depois.',   points:{decisao:3,logica:3,sagacidade:4,maturidade:5}, tag:'maturidade_alta'},
    ],
  },
  {
    ...
    options:[
      {text:'Resolvo as 2 com maior impacto sistêmico — a terceira terá menor efeito com as principais sanadas.',points:{decisao:4,logica:5,sagacidade:4,maturidade:4}, tag:'logica_alta'},
      {text:'Resolvo as 2 mais rápidas — velocidade libera recursos para a terceira.',         points:{decisao:3,logica:3,sagacidade:3,maturidade:3}, tag:'logica_media'},
      {text:'Resolvo as 2 que a equipe executa melhor — qualidade da solução importa mais.',  points:{decisao:3,logica:4,sagacidade:5,maturidade:4}, tag:'sagacidade_alta'},
      {text:'Resolvo 1 completamente e mitigo as outras 2 parcialmente.',                     points:{decisao:4,logica:5,sagacidade:3,maturidade:3}, tag:'logica_alta'},
    ],
  },
  {
    id:'ad3', block:'sagacidade', peso:'critico', type:'adaptive',
    triggers:['sagacidade_alta','sagacidade_manipuladora'],
    text:'Você tem informação antiética mas que daria vantagem enorme em uma disputa. Você usa?',
    options:[
      {text:'Não. Vantagem obtida de forma antiética contamina o que vier depois.',            points:{decisao:3,logica:3,sagacidade:4,maturidade:5}, tag:'maturidade_alta'},
      {text:'Uso como orientação para onde buscar informação legítima — sem citar a fonte.',   points:{decisao:4,logica:4,sagacidade:5,maturidade:3}, tag:'sagacidade_alta'},
      {text:'Uso. Resultados importam mais que a origem dos insumos.',                         points:{decisao:4,logica:2,sagacidade:3,maturidade:1}, tag:'maturidade_baixa'},
      {text:'Descarto e busco equivalente por meios legítimos, mesmo que demore.',             points:{decisao:3,logica:3,sagacidade:3,maturidade:5}, tag:'maturidade_alta'},
    ],
  },
  {
    ...
    options:[
      {text:'Orgulho genuíno — superar o mestre é o objetivo do processo.',                   points:{decisao:3,logica:3,sagacidade:4,maturidade:5}, tag:'maturidade_alta'},
      {text:'Satisfação com ressalva de ego — trabalho para reconquistar vantagem em outra dimensão.',points:{decisao:4,logica:3,sagacidade:4,maturidade:4}, tag:'decisao_analitico'},
      {text:'Rivalidade velada — é difícil ser honesto sobre isso.',                          points:{decisao:2,logica:2,sagacidade:3,maturidade:2}, tag:'maturidade_baixa'},
      {text:'Alívio — significa que meu trabalho de desenvolvimento foi eficaz.',             points:{decisao:3,logica:3,sagacidade:3,maturidade:5}, tag:'maturidade_alta'},
    ],
  },
  {
    ...
    options:[
      {text:'Decido com os dados disponíveis — decisão imperfeita no prazo supera decisão perfeita fora dele.',points:{decisao:5,logica:4,sagacidade:4,maturidade:4}, tag:'decisao_lider'},
      {text:'Modelos probabilísticos com dados parciais — projeto cenários e decido dentro deles.',points:{decisao:4,logica:5,sagacidade:4,maturidade:3}, tag:'logica_alta'},
      {text:'Negocio extensão do prazo — 5 dias extras podem mudar tudo.',                   points:{decisao:4,logica:3,sagacidade:5,maturidade:4}, tag:'sagacidade_alta'},
      {text:'Passo. Oportunidade que não permite análise adequada não é boa oportunidade.',   points:{decisao:2,logica:4,sagacidade:3,maturidade:4}, tag:'decisao_conservador'},
    ],
  },
];
...
const ESPECTROS = {
  CORVUS:{
    ...
    match:(n)=> n.sagacidade>=68 && n.logica>=62,
  },
  FENRIR:{
    ...
    match:(n)=> n.decisao>=72 && n.maturidade<55,
  },
  AEGIS:{
    ...
    match:(n)=> n.maturidade>=72 && n.decisao>=55,
  },
  VORTEX:{
    ...
    match:(n)=> n.sagacidade>=70 && n.maturidade>=60,
  },
  TITAN:{
    ...
    match:(n)=> n.decisao>=65 && n.logica>=55 && n.sagacidade<60,
  },
  CIPHER:{
    ...
    match:(n)=> n.logica>=70 && n.sagacidade>=55,
  },
  SPECTER:{
    ...
    match:(n)=> n.sagacidade>=62 && n.maturidade>=65 && n.decisao<65,
  },
};
...
function saveState() {
  ...
  catch(e){ console.warn('ICM3: save failed', e); }
}
...
/**
 * Calcula o ICM final com:
 * - Pesos por dimensão
 * - Ajuste por consistência e confiabilidade
 * - Penalidades de análise cruzada
 * - Floor em 5
 */
function calcICM(norm, consistency, reliability) {
  const dw = CFG.DIM_WEIGHTS;
  const totalW = Object.values(dw).reduce((a,b) => a+b, 0);
  const dimScore = Object.entries(norm).reduce((acc,[k,v]) => acc + v * dw[k], 0) / totalW;

  // Ajuste pelos índices ocultos
  const consistAdj   = ((consistency - 50) / 50) * 100 * CFG.CONSISTENCY_INFLUENCE;
  const reliableAdj  = ((reliability - 50)  / 50) * 100 * CFG.RELIABILITY_INFLUENCE;

  // Aplica regras de cross-analysis
  let crossAdj = 0;
  ...
  const raw = dimScore + consistAdj + reliableAdj + crossAdj;
...
function getEspectros(norm) {
  // Busca dominante
  let primary = null;
  for (const esp of Object.values(ESPECTROS)) {
    if (esp.match(norm)) { primary = esp; break; }
  }
  if (!primary) {
    // Fallback por dimensão mais alta
    const topDim = Object.entries(norm).sort((a,b)=>b[1]-a[1])[0][0];
    const fbMap = { decisao:ESPECTROS.TITAN, logica:ESPECTROS.CIPHER, sagacidade:ESPECTROS.VORTEX, maturidade:ESPECTROS.AEGIS };
    primary = fbMap[topDim] || ESPECTROS.CORVUS;
  }
  // Busca secundário (diferente do primário)
  let secondary = null;
  for (const esp of Object.values(ESPECTROS)) {
    if (esp !== primary && esp.match({ ...norm, decisao: norm.decisao * 0.85, sagacidade: norm.sagacidade * 0.85 })) {
      secondary = esp; break;
    }
  }
  if (!secondary) {
    // Segundo fallback: segunda dimensão mais alta
    const sorted = Object.entries(norm).sort((a,b)=>b[1]-a[1]);
    const secDim = sorted[1][0];
    const fbMap  = { decisao:ESPECTROS.TITAN, logica:ESPECTROS.CIPHER, sagacidade:ESPECTROS.VORTEX, maturidade:ESPECTROS.AEGIS };
    secondary = fbMap[secDim] || ESPECTROS.SPECTER;
    if (secondary === primary) secondary = ESPECTROS.SPECTER;
  }
...
function showResult() {
  ...
  DIMS.forEach((k,i) => {
    setTimeout(() => {
      document.getElementById('dv-'+k).textContent  = norm[k]+'%';
      const bar = document.getElementById('db-'+k);
      if (bar) bar.style.width = norm[k]+'%';
      document.getElementById('dt-'+k).textContent  = getDimTier(norm[k]);
      document.getElementById('dd-'+k).textContent  = getDimDesc(k, norm[k]);
    }, 500 + i*180);
  });
  ...
  // ── Interpretação ──
  const { strong, risk, deep, potential } = getInterpretation(norm, ICM, consistency);
